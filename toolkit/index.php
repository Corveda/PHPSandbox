<?php
    ...
    if(isset($_POST['save']) || isset($_POST['download'])){
        if(isset($_POST['download'])){
            $data = json_decode($_POST['download'], JSON_OBJECT_AS_ARRAY);
            if(!is_array($data)){
                header('Content-type: text/html');
...
<div id="help_dialog" title="Help">
    <div style="height: 540px;">
        <div id="help_topics">
            <h3>1 - About PHPSandbox &amp; This Toolkit</h3>
            <div>
                <div align="center">
                    <a href="https://github.com/fieryprophet/php-sandbox" target="_blank">
                        <img src="data:image/png;base64," alt="PHPSandbox" style="border: 0;">
                    </a>
                    <br/>
                    <h1 style="margin: 0;">
                        PHPSandbox Toolkit 1.0
                    </h1>
                    <br/>
                    <strong>Developed by: </strong> <a href="http://www.fieryprophet.com" target="_blank">Elijah Horton</a>
                    &mdash;
                    <a href="https://github.com/fieryprophet/php-sandbox" target="_blank">Github</a>
                </div>
                <p>PHPSandbox is a PHP 5.3.2+ class designed to implement tightly-controlled and highly configurable code
                    sandboxes in pure PHP code.
                It utilizes the <a href="https://github.com/nikic/PHP-Parser" target="_blank">PHPParser</a> and
                    <a href="https://github.com/jeremeamia/FunctionParser" target="_blank">FunctionParser</a>
                libraries to parse the sandboxed code for violations of the sandbox configuration and to disassemble
                    closures passed to the sandbox.</p>
                <p>This toolkit is used to demonstrate the use of the PHPSandbox class, its various configuration
                    options, creation of custom templates and for easy experimentation. The JSON templates it generates
                    can also be imported direclty into a PHPSandbox instance to allow for easy sharing of common configurations.</p>
                <p>The PHPSandbox project is licensed under the open source BSD License. Click the "License" tab below or
                    see the LICENSE file that came with your distribution for more information.</p>
                <p><strong>Click the "Getting Started" tab below to continue.</strong></p>
                <hr class="hr"/>
                <p><strong>WARNING: This toolkit is NOT DESIGNED to be used on a publicly accessible server! It is for
                    <em>local</em> testing in a private environment only! Use of this toolkit on a public-facing server
                    will likely lead to immediate rooting of your server! YOU HAVE BEEN WARNED!</strong></p>
            </div>
            <h3>2 - Getting Started</h3>
            <div>
                <h3>The Toolbar</h3>
                <p>The far right of the toolkit screen is the toolbar. Links to the API documentation and this help
                    dialog can be found here. This is also where sandbox templates, stored in the /toolkit/templates/
                    folder, can be selected and automatically loaded in the toolkit environment to test, or templates can
                    be imported from your local filesystem.</p>
                <p>More importantly, this is where the various sandbox configuration options can be selected, whitelists
                and blacklists can be enabled, and definitions for functions, superglobals, etc. can be defined.</p>
                <p>Finally, the error level for the code to be executed can be set, and clicking "Run Code In Sandbox"
                will execute the toolkit environment and output the response.</p>
                <h3>The Code Editor</h3>
                <p>The top left of the toolkit screen is the code editor, which can be set to four possible modes via the
                    <strong>Editor Mode</strong> menu above the code editor. These modes are:</p>
                <ul>
                    <li>
                        <strong>Sandboxed Code</strong> &mdash; Code entered in this mode will be run within the sandbox
                        environment, and will be subject to all validation checks determined by the sandbox configuration.
                    </li>
                    <li>
                        <strong>Setup Code</strong> &mdash; This is a special mode that allows the toolkit to run trusted
                        code outside the sandbox, in the global scope of the script. This will allow for testing the sandbox
                        against globally scoped functions, variables, etc. it is <strong>NOT</strong> subject to any validation
                        checks, and <strong>can do anything a typical PHP script can!</strong>
                    </li>
                    <li>
                        <strong>Prepended Code</strong> &mdash; Code entered in this mode will be automatically trusted
                        by the sandboxed and will run before the sandboxed code runs, in the same execution scope as the
                        sandbox. If auto_whitelist is not enabled you will likely run into validation errors if the sandboxed
                        code attempts to use classes or functions declared by this code.
                    </li>
                    <li>
                        <strong>Appended Code</strong> &mdash; Code entered in this mode is treated exactly the same as
                        prepended code except it is run after the sandboxed code runs, and in the same execution scope.
                    </li>
                </ul>
                <h3>The Output Box</h3>
                <p>When "Run Code In Sandbox" is clicked, any execution output is sent to this box, including error messages,
                uncaught exceptions and echoed output. Any values returned by the sandbox via the <em>return</em> keyword
                will also be shown as a <em>var_dump</em> output in a line underneath the echoed output.</p>
                <p>Finally, a line will be shown at the end of the output showing the amount of milliseconds spent preparing
                    and executing the sandbox as well as the total time spent.</p>
                <p><strong>Click the "Using Templates" tab below to continue.</strong></p>
            </div>
            <h3>3 - Using Templates</h3>
            <div>
                <p>This toolkit comes with a special template feature that allows for you to open and save templates in a
                JSON format that the PHPSandbox class can easily import. This makes the sharing of sandboxed configurations
                incredibly easy as well as making it simple to extend existing templates for your own uses.</p>
                <h3>Loading Templates</h3>
                <p>To load a template, simply select a template from the dropdown list of available templates in the
                    /toolkit/templates/ folder, or click "Import A Template" to load one from your local filesystem.
                    Once a template is selected the toolkit environment will automatically load all the template options,
                    whitelists, blacklists, definitions, and all setup, trusted and sandboxed code in their respective modes.</p>
                <h3>Saving Templates</h3>
                <p>If you wish to save your current sandbox configuration, simply click the "Save As New Template" button.
                You will be prompted for a name for your new template. Once you have named your template, you will be
                    alerted to the success or failure of the operation, and your template will be stored in the
                    /toolkit/templates/ folder. Once your template is saved it automatically becomes available in the
                    dropdown templates menu for you to choose from. If you check the "Download Template?" checkbox you
                    will be prompted to download your template and save it in a location of your choosing instead of
                    saving it to the /toolkit/templates/ folder.</p>
                <p><strong>Click the "Configuring Your Sandbox" tab below to continue.</strong></p>
            </div>
            <h4>4 - Configuring Your Sandbox</h4>
            <div>
                <p>You have four main sections of configurations for your sandboxed environment: <strong>Options</strong>,
                    <strong>Whitelists</strong>, <strong>Blacklists</strong> and <strong>Definitions.</strong></p>
            </div>
        </div>
    </div>
    <div align="center" style="font-size: 10px;">
        <strong>&copy; Copyright <?=date("Y");?> Elijah Horton</strong> &mdash; <a href="http://www.fieryprophet.com" target="_blank">fieryprophet.com</a>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("a.help").on('click', function(){
            ...
            $("#help_topics").accordion({heightStyle: "fill"});
        });
    });
</script>
</body>
