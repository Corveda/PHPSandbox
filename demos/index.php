    ...
    $(function(){
        ...
        $("#run, #save").button().on('click', function(){
            ...
            if($(this).attr('id') == 'save'){
                ...
                $.post("./", {"code": code, "options": options, "whitelist" : whitelist, "blacklist": blacklist, "save": name}, function(response){
                ...
                $.post("./", {"code": code, "options": options, "whitelist" : whitelist, "blacklist": blacklist}, function(response){
